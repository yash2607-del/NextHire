...
export default function Footer() {
  return (
    <div className="bg-white pt-4 pt-md-10 pt-lg-12">
      <footer className="container px-4 px-md-8 mx-auto">
        <div className="row border-top pt-10 pt-lg-12 mb-16">
          ...
          <div className="col-6 col-md-3 col-lg-2 mb-4">
            <div className="text-dark font-weight-bold text-uppercase mb-4">
              Products
            </div>
